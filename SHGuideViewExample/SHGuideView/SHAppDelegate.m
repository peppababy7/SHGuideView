...
//  SHGuideView
//
//  Created by @harushuu on 07/02/2016.
...
- (void)pushRootViewController {
    if ([SHGuideViewController needShowGuidePage]) {
        ...
        [UIView transitionWithView:[[[UIApplication sharedApplication] delegate] window] duration:0.4 options:UIViewAnimationOptionTransitionCrossDissolve animations:^{
            ...
            [[[[UIApplication sharedApplication] delegate] window] setRootViewController:guideViewController];
...
- (void)pushMainViewController {
    SHViewController *mainViewController = [[SHViewController alloc] init];
